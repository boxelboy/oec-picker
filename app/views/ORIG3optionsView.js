...
-------------------------------------------------------------------------------------------------------------------------*/
		...
		keyOption: function (e)
		{
			...
			if (e.keyCode == 13)
			{
				...
				//console.log('keyOption saved', saved);
...
-------------------------------------------------------------------------------------------------------------------------*/
				...
				itemSaveModel.save().done(_.bind(function(response){
					if (data.calculation) {this.trigger('calc', response);}
				}, this));
		...
		selectOption: function (e)
		{
			...
			var saved = this.saveOption(saveData);
			//console.log('selectOption saved',saved);
